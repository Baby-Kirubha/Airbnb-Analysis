...
def data_extraction():
    import pymongo
    connection=pymongo.MongoClient("mongodb+srv://Babykirubha:11721200#Baby@cluster0.utjqopu.mongodb.net/?retryWrites=true&w=majority")
...
def dataframe():    
    import pandas as pd
    df1 = pd.DataFrame(basket)
    file_path = 'C:/Users/babyk/OneDrive/Documents/projects/project 4/basket1.csv'
    df1.to_csv(file_path, index=False)
    df2 = pd.DataFrame(comment)
    file_path = 'C:/Users/babyk/OneDrive/Documents/projects/project 4/comment.csv'
...
def EDA():
    ...
    file_path = 'C:/Users/babyk/OneDrive/Documents/projects/project 4/basketEDA.csv'
    DF.to_csv(file_path, index=False)
    file_path = 'C:/Users/babyk/OneDrive/Documents/projects/project 4/commentEDA.csv'
    df2.to_csv(file_path, index=False)
    return "success"
...
def sql():
    import pandas as pd
    DF=pd.read_csv("basketEDA.csv")
    df=pd.read_csv("commentEDA.csv")
    import pymysql
    myconnection=pymysql.connect(host="127.0.0.1",user="root",passwd="11721200#Baby")
    cur=myconnection.cursor()
    cur.execute("create database if not exists pro4")
    myconnection=pymysql.connect(host="127.0.0.1",user="root",passwd="11721200#Baby",database="pro4")
    cur=myconnection.cursor()
...
st.markdown("<h1 style='text-align: center; color: green;'>AIRBNB ANALYSIS</h1>", unsafe_allow_html=True)
SELECT=option_menu(
    menu_title=None,
...
if SELECT=="Home":
    image1 = Image.open(r"C:\Users\babyk\OneDrive\Pictures\Screenshots\Screenshot (86).png")
